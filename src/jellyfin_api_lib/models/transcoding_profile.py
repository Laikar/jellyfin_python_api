...
class TranscodingProfile:
    ...
    estimate_content_length: Unset | bool = False
    enable_mpegts_m2_ts_mode: Unset | bool = False
    transcode_seek_info: Unset | TranscodeSeekInfo = TranscodeSeekInfo.AUTO
    copy_timestamps: Unset | bool = False
    context: Unset | EncodingContext = EncodingContext.STREAMING
    enable_subtitles_in_manifest: Unset | bool = False
    max_audio_channels: None | Unset | str = UNSET
    min_segments: Unset | int = 0
    segment_length: Unset | int = 0
    break_on_non_key_frames: Unset | bool = False
    conditions: Unset | list["ProfileCondition"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        transcode_seek_info: Unset | str = UNSET
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        transcode_seek_info: Unset | TranscodeSeekInfo
        ...
        def _parse_max_audio_channels(data: object) -> None | Unset | str:
            if data is None:
                return data
