...
class QuickConnectResult:
    ...
    authenticated: Unset | bool = UNSET
    secret: Unset | str = UNSET
    code: Unset | str = UNSET
    device_id: Unset | str = UNSET
    device_name: Unset | str = UNSET
    app_name: Unset | str = UNSET
    app_version: Unset | str = UNSET
    date_added: Unset | datetime.datetime = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        date_added: Unset | datetime.datetime
