...
class ServerConfiguration:
    ...
    log_file_retention_days: Unset | int = UNSET
    is_startup_wizard_completed: Unset | bool = UNSET
    cache_path: None | Unset | str = UNSET
    previous_version: None | Unset | str = UNSET
    previous_version_str: None | Unset | str = UNSET
    enable_metrics: Unset | bool = UNSET
    enable_normalized_item_by_name_ids: Unset | bool = UNSET
    is_port_authorized: Unset | bool = UNSET
    quick_connect_available: Unset | bool = UNSET
    enable_case_sensitive_item_ids: Unset | bool = UNSET
    disable_live_tv_channel_user_data_name: Unset | bool = UNSET
    metadata_path: Unset | str = UNSET
    metadata_network_path: Unset | str = UNSET
    preferred_metadata_language: Unset | str = UNSET
    metadata_country_code: Unset | str = UNSET
    sort_replace_characters: Unset | list[str] = UNSET
    sort_remove_characters: Unset | list[str] = UNSET
    sort_remove_words: Unset | list[str] = UNSET
    min_resume_pct: Unset | int = UNSET
    max_resume_pct: Unset | int = UNSET
    min_resume_duration_seconds: Unset | int = UNSET
    min_audiobook_resume: Unset | int = UNSET
    max_audiobook_resume: Unset | int = UNSET
    library_monitor_delay: Unset | int = UNSET
    image_saving_convention: Unset | ImageSavingConvention = UNSET
    metadata_options: Unset | list["MetadataOptions"] = UNSET
    skip_deserialization_for_basic_types: Unset | bool = UNSET
    server_name: Unset | str = UNSET
    ui_culture: Unset | str = UNSET
    save_metadata_hidden: Unset | bool = UNSET
    content_types: Unset | list["NameValuePair"] = UNSET
    remote_client_bitrate_limit: Unset | int = UNSET
    enable_folder_view: Unset | bool = UNSET
    enable_grouping_into_collections: Unset | bool = UNSET
    display_specials_within_seasons: Unset | bool = UNSET
    codecs_used: Unset | list[str] = UNSET
    plugin_repositories: Unset | list["RepositoryInfo"] = UNSET
    enable_external_content_in_suggestions: Unset | bool = UNSET
    image_extraction_timeout_ms: Unset | int = UNSET
    path_substitutions: Unset | list["PathSubstitution"] = UNSET
    enable_slow_response_warning: Unset | bool = UNSET
    slow_response_threshold_ms: Unset | int = UNSET
    cors_hosts: Unset | list[str] = UNSET
    activity_log_retention_days: None | Unset | int = UNSET
    library_scan_fanout_concurrency: Unset | int = UNSET
    library_metadata_refresh_concurrency: Unset | int = UNSET
    remove_old_plugins: Unset | bool = UNSET
    allow_client_log_upload: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        content_types: Unset | list[dict[str, Any]] = UNSET
        ...
        plugin_repositories: Unset | list[dict[str, Any]] = UNSET
        ...
        path_substitutions: Unset | list[dict[str, Any]] = UNSET
        ...
        activity_log_retention_days: None | Unset | int
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_cache_path(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_previous_version(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_previous_version_str(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        image_saving_convention: Unset | ImageSavingConvention
        ...
        def _parse_activity_log_retention_days(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
