...
class TaskInfo:
    ...
    state: Unset | TaskState = UNSET
    current_progress_percentage: None | Unset | float = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        current_progress_percentage: None | Unset | float
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        state: Unset | TaskState
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = TaskState(_state)

        def _parse_current_progress_percentage(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
