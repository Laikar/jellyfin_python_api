...
class UserConfiguration:
    ...
    audio_language_preference: None | Unset | str = UNSET
    play_default_audio_track: Unset | bool = UNSET
    subtitle_language_preference: None | Unset | str = UNSET
    display_missing_episodes: Unset | bool = UNSET
    grouped_folders: Unset | list[str] = UNSET
    subtitle_mode: Unset | SubtitlePlaybackMode = UNSET
    display_collections_view: Unset | bool = UNSET
    enable_local_password: Unset | bool = UNSET
    ordered_views: Unset | list[str] = UNSET
    latest_items_excludes: Unset | list[str] = UNSET
    my_media_excludes: Unset | list[str] = UNSET
    hide_played_in_latest: Unset | bool = UNSET
    remember_audio_selections: Unset | bool = UNSET
    remember_subtitle_selections: Unset | bool = UNSET
    enable_next_episode_auto_play: Unset | bool = UNSET

    def to_dict(self) -> dict[str, Any]:
        audio_language_preference: None | Unset | str
        ...
        subtitle_language_preference: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_audio_language_preference(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        audio_language_preference = _parse_audio_language_preference(d.pop("AudioLanguagePreference", UNSET))

        play_default_audio_track = d.pop("PlayDefaultAudioTrack", UNSET)

        def _parse_subtitle_language_preference(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        subtitle_language_preference = _parse_subtitle_language_preference(d.pop("SubtitleLanguagePreference", UNSET))
        ...
        subtitle_mode: Unset | SubtitlePlaybackMode
