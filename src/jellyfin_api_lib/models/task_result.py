...
class TaskResult:
    ...
    start_time_utc: Unset | datetime.datetime = UNSET
    end_time_utc: Unset | datetime.datetime = UNSET
    status: Unset | TaskCompletionStatus = UNSET
    name: None | Unset | str = UNSET
    key: None | Unset | str = UNSET
    id: None | Unset | str = UNSET
    error_message: None | Unset | str = UNSET
    long_error_message: None | Unset | str = UNSET

    def to_dict(self) -> dict[str, Any]:
        start_time_utc: Unset | str = UNSET
        if not isinstance(self.start_time_utc, Unset):
            start_time_utc = self.start_time_utc.isoformat()

        end_time_utc: Unset | str = UNSET
        ...
        long_error_message: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        start_time_utc: Unset | datetime.datetime
        ...
        end_time_utc: Unset | datetime.datetime
        ...
        status: Unset | TaskCompletionStatus
        ...
        def _parse_long_error_message(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
