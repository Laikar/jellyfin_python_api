...
class ConfigurationPageInfo:
    ...
    menu_section: None | Unset | str = UNSET
    menu_icon: None | Unset | str = UNSET
    display_name: None | Unset | str = UNSET
    plugin_id: None | Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_menu_section(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_menu_icon(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_plugin_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
