...
class AuthenticationInfoQueryResult:
    """
    Attributes:
        items (Union[List['AuthenticationInfo'], None, Unset]): Gets or sets the items.
    ...
    items: list["AuthenticationInfo"] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_items(data: object) -> list["AuthenticationInfo"] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for items_type_0_item_data in _items_type_0:
                    items_type_0_item = AuthenticationInfo.from_dict(items_type_0_item_data)
                ...
                pass
            return cast(list["AuthenticationInfo"] | None | Unset, data)
