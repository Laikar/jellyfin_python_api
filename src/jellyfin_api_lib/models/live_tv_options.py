...
class LiveTvOptions:
    ...
    guide_days: None | Unset | int = UNSET
    recording_path: None | Unset | str = UNSET
    movie_recording_path: None | Unset | str = UNSET
    series_recording_path: None | Unset | str = UNSET
    enable_recording_subfolders: Unset | bool = UNSET
    enable_original_audio_with_encoded_recordings: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.listing_providers, Unset):
            ...
            for listing_providers_type_0_item_data in self.listing_providers:
                listing_providers_type_0_item = listing_providers_type_0_item_data.to_dict()
        ...
        recording_post_processor: None | Unset | str
        ...
        recording_post_processor_arguments: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_guide_days(data: object) -> None | Unset | int:
            if data is None:
                return data
        ...
        def _parse_recording_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_movie_recording_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        movie_recording_path = _parse_movie_recording_path(d.pop("MovieRecordingPath", UNSET))

        def _parse_series_recording_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        series_recording_path = _parse_series_recording_path(d.pop("SeriesRecordingPath", UNSET))
        ...
        def _parse_tuner_hosts(data: object) -> list["TunerHostInfo"] | None | Unset:
            ...
            try:
                ...
                for tuner_hosts_type_0_item_data in _tuner_hosts_type_0:
                    tuner_hosts_type_0_item = TunerHostInfo.from_dict(tuner_hosts_type_0_item_data)
        ...
        def _parse_listing_providers(data: object) -> list["ListingsProviderInfo"] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for listing_providers_type_0_item_data in _listing_providers_type_0:
                    listing_providers_type_0_item = ListingsProviderInfo.from_dict(listing_providers_type_0_item_data)
        ...
        media_locations_created = _parse_media_locations_created(d.pop("MediaLocationsCreated", UNSET))

        def _parse_recording_post_processor(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        recording_post_processor = _parse_recording_post_processor(d.pop("RecordingPostProcessor", UNSET))

        def _parse_recording_post_processor_arguments(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        recording_post_processor_arguments = _parse_recording_post_processor_arguments(d.pop("RecordingPostProcessorArguments", UNSET))
