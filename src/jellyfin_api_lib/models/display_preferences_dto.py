...
class DisplayPreferencesDto:
    ...
    view_type: None | Unset | str = UNSET
    sort_by: None | Unset | str = UNSET
    index_by: None | Unset | str = UNSET
    remember_indexing: Unset | bool = UNSET
    primary_image_height: Unset | int = UNSET
    primary_image_width: Unset | int = UNSET
    custom_prefs: Union[Unset, "DisplayPreferencesDtoCustomPrefs"] = UNSET
    scroll_direction: Unset | ScrollDirection = UNSET
    show_backdrop: Unset | bool = UNSET
    remember_sorting: Unset | bool = UNSET
    sort_order: Unset | SortOrder = UNSET
    show_sidebar: Unset | bool = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_view_type(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_sort_by(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_index_by(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        custom_prefs: Unset | DisplayPreferencesDtoCustomPrefs
        ...
        scroll_direction: Unset | ScrollDirection
