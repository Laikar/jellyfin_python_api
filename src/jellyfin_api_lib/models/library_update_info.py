...
class LibraryUpdateInfo:
    ...
    folders_added_to: Unset | list[str] = UNSET
    folders_removed_from: Unset | list[str] = UNSET
    items_added: Unset | list[str] = UNSET
    items_removed: Unset | list[str] = UNSET
    items_updated: Unset | list[str] = UNSET
    collection_folders: Unset | list[str] = UNSET
    is_empty: Unset | bool = UNSET
