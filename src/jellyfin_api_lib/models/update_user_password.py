...
class UpdateUserPassword:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_current_password(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_current_pw(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
