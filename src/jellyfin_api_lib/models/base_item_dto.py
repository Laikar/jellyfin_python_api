...
if TYPE_CHECKING:
    from ..models.base_item_dto_image_blur_hashes_type_0 import BaseItemDtoImageBlurHashesType0
...
class BaseItemDto:
    ...
    This holds information about a BaseItem in a format that is convenient for the client.
        ...
        Attributes:
            ...
            extra_type (Union[None, Unset, str]):
            ...
            supports_sync (Union[None, Unset, bool]): Gets or sets a value indicating whether [supports synchronize].
            ...
            video_3d_format (Union[None, Unset, Video3DFormat]): Gets or sets the video3 D format.
            ...
            play_access (Union[None, PlayAccess, Unset]): Gets or sets the play access.
            ...
            parent_logo_item_id (Union[None, Unset, str]): Gets or sets wether the item has a logo, this will hold the Id of
                the Parent that has one.
            parent_backdrop_item_id (Union[None, Unset, str]): Gets or sets wether the item has any backdrops, this will
            ...
            collection_type (Union[None, Unset, str]): Gets or sets the type of the collection.
            ...
            video_type (Union[None, Unset, VideoType]): Gets or sets the type of the video.
            ...
            parent_art_item_id (Union[None, Unset, str]): Gets or sets wether the item has fan art, this will hold the Id of
                the Parent that has one.
            ...
            location_type (Union[LocationType, None, Unset]): Gets or sets the type of the location.
            iso_type (Union[IsoType, None, Unset]): Gets or sets the type of the iso.
            ...
            image_orientation (Union[ImageOrientation, None, Unset]):
            ...
            channel_type (Union[ChannelType, None, Unset]): Gets or sets the type of the channel.
            audio (Union[None, ProgramAudio, Unset]): Gets or sets the audio.
    ...
    id: Unset | str = UNSET
    etag: None | Unset | str = UNSET
    source_type: None | Unset | str = UNSET
    playlist_item_id: None | Unset | str = UNSET
    date_created: None | Unset | datetime.datetime = UNSET
    date_last_media_added: None | Unset | datetime.datetime = UNSET
    extra_type: None | Unset | str = UNSET
    airs_before_season_number: None | Unset | int = UNSET
    airs_after_season_number: None | Unset | int = UNSET
    airs_before_episode_number: None | Unset | int = UNSET
    can_delete: None | Unset | bool = UNSET
    can_download: None | Unset | bool = UNSET
    has_subtitles: None | Unset | bool = UNSET
    preferred_metadata_language: None | Unset | str = UNSET
    preferred_metadata_country_code: None | Unset | str = UNSET
    supports_sync: None | Unset | bool = UNSET
    container: None | Unset | str = UNSET
    sort_name: None | Unset | str = UNSET
    forced_sort_name: None | Unset | str = UNSET
    ...
    critic_rating: None | Unset | float = UNSET
    production_locations: list[str] | None | Unset = UNSET
    path: None | Unset | str = UNSET
    enable_media_source_display: None | Unset | bool = UNSET
    official_rating: None | Unset | str = UNSET
    custom_rating: None | Unset | str = UNSET
    channel_id: None | Unset | str = UNSET
    channel_name: None | Unset | str = UNSET
    overview: None | Unset | str = UNSET
    taglines: list[str] | None | Unset = UNSET
    genres: list[str] | None | Unset = UNSET
    community_rating: None | Unset | float = UNSET
    cumulative_run_time_ticks: None | Unset | int = UNSET
    run_time_ticks: None | Unset | int = UNSET
    play_access: None | PlayAccess | Unset = UNSET
    aspect_ratio: None | Unset | str = UNSET
    production_year: None | Unset | int = UNSET
    is_place_holder: None | Unset | bool = UNSET
    number: None | Unset | str = UNSET
    channel_number: None | Unset | str = UNSET
    index_number: None | Unset | int = UNSET
    index_number_end: None | Unset | int = UNSET
    ...
    parent_logo_item_id: None | Unset | str = UNSET
    parent_backdrop_item_id: None | Unset | str = UNSET
    parent_backdrop_image_tags: list[str] | None | Unset = UNSET
    local_trailer_count: None | Unset | int = UNSET
    user_data: Union["UserItemDataDto", None, Unset] = UNSET
    recursive_item_count: None | Unset | int = UNSET
    child_count: None | Unset | int = UNSET
    series_name: None | Unset | str = UNSET
    series_id: None | Unset | str = UNSET
    season_id: None | Unset | str = UNSET
    special_feature_count: None | Unset | int = UNSET
    display_preferences_id: None | Unset | str = UNSET
    status: None | Unset | str = UNSET
    air_time: None | Unset | str = UNSET
    ...
    collection_type: None | Unset | str = UNSET
    display_order: None | Unset | str = UNSET
    album_id: None | Unset | str = UNSET
    album_primary_image_tag: None | Unset | str = UNSET
    series_primary_image_tag: None | Unset | str = UNSET
    album_artist: None | Unset | str = UNSET
    album_artists: list["NameGuidPair"] | None | Unset = UNSET
    season_name: None | Unset | str = UNSET
    media_streams: list["MediaStream"] | None | Unset = UNSET
    video_type: None | Unset | VideoType = UNSET
    part_count: None | Unset | int = UNSET
    media_source_count: None | Unset | int = UNSET
    ...
    parent_logo_image_tag: None | Unset | str = UNSET
    parent_art_item_id: None | Unset | str = UNSET
    parent_art_image_tag: None | Unset | str = UNSET
    series_thumb_image_tag: None | Unset | str = UNSET
    image_blur_hashes: Union["BaseItemDtoImageBlurHashesType0", None, Unset] = UNSET
    series_studio: None | Unset | str = UNSET
    parent_thumb_item_id: None | Unset | str = UNSET
    parent_thumb_image_tag: None | Unset | str = UNSET
    parent_primary_image_item_id: None | Unset | str = UNSET
    parent_primary_image_tag: None | Unset | str = UNSET
    ...
    trailer_count: None | Unset | int = UNSET
    movie_count: None | Unset | int = UNSET
    series_count: None | Unset | int = UNSET
    program_count: None | Unset | int = UNSET
    episode_count: None | Unset | int = UNSET
    song_count: None | Unset | int = UNSET
    album_count: None | Unset | int = UNSET
    artist_count: None | Unset | int = UNSET
    music_video_count: None | Unset | int = UNSET
    lock_data: None | Unset | bool = UNSET
    width: None | Unset | int = UNSET
    height: None | Unset | int = UNSET
    camera_make: None | Unset | str = UNSET
    camera_model: None | Unset | str = UNSET
    software: None | Unset | str = UNSET
    exposure_time: None | Unset | float = UNSET
    focal_length: None | Unset | float = UNSET
    image_orientation: ImageOrientation | None | Unset = UNSET
    aperture: None | Unset | float = UNSET
    shutter_speed: None | Unset | float = UNSET
    latitude: None | Unset | float = UNSET
    longitude: None | Unset | float = UNSET
    altitude: None | Unset | float = UNSET
    iso_speed_rating: None | Unset | int = UNSET
    series_timer_id: None | Unset | str = UNSET
    program_id: None | Unset | str = UNSET
    channel_primary_image_tag: None | Unset | str = UNSET
    start_date: None | Unset | datetime.datetime = UNSET
    completion_percentage: None | Unset | float = UNSET
    is_repeat: None | Unset | bool = UNSET
    episode_title: None | Unset | str = UNSET
    channel_type: ChannelType | None | Unset = UNSET
    audio: None | ProgramAudio | Unset = UNSET
    is_movie: None | Unset | bool = UNSET
    is_sports: None | Unset | bool = UNSET
    is_series: None | Unset | bool = UNSET
    is_live: None | Unset | bool = UNSET
    is_news: None | Unset | bool = UNSET
    is_kids: None | Unset | bool = UNSET
    is_premiere: None | Unset | bool = UNSET
    timer_id: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        date_last_media_added: None | Unset | str
        ...
        extra_type: None | Unset | str
        if isinstance(self.extra_type, Unset):
            extra_type = UNSET
        else:
            extra_type = self.extra_type

        airs_before_season_number: None | Unset | int
        ...
        airs_after_season_number: None | Unset | int
        ...
        airs_before_episode_number: None | Unset | int
        ...
        can_delete: None | Unset | bool
        if isinstance(self.can_delete, Unset):
            can_delete = UNSET
        else:
            can_delete = self.can_delete

        can_download: None | Unset | bool
        if isinstance(self.can_download, Unset):
            can_download = UNSET
        else:
            can_download = self.can_download

        has_subtitles: None | Unset | bool
        ...
        preferred_metadata_country_code: None | Unset | str
        ...
        sort_name: None | Unset | str
        if isinstance(self.sort_name, Unset):
            sort_name = UNSET
        else:
            sort_name = self.sort_name

        forced_sort_name: None | Unset | str
        ...
        critic_rating: None | Unset | float
        ...
        enable_media_source_display: None | Unset | bool
        ...
        cumulative_run_time_ticks: None | Unset | int
        ...
        play_access: None | Unset | str
        if isinstance(self.play_access, Unset):
            play_access = UNSET
        elif isinstance(self.play_access, PlayAccess):
            play_access = self.play_access.value
        else:
            play_access = self.play_access
        ...
        index_number_end: None | Unset | int
        ...
        local_trailer_count: None | Unset | int
        ...
        display_preferences_id: None | Unset | str
        ...
        display_order: None | Unset | str
        if isinstance(self.display_order, Unset):
            display_order = UNSET
        else:
            display_order = self.display_order

        album_id: None | Unset | str
        if isinstance(self.album_id, Unset):
            album_id = UNSET
        else:
            album_id = self.album_id

        album_primary_image_tag: None | Unset | str
        ...
        series_primary_image_tag: None | Unset | str
        ...
        part_count: None | Unset | int
        if isinstance(self.part_count, Unset):
            part_count = UNSET
        else:
            part_count = self.part_count

        media_source_count: None | Unset | int
        ...
        parent_logo_image_tag: None | Unset | str
        ...
        parent_primary_image_item_id: None | Unset | str
        ...
        parent_primary_image_tag: None | Unset | str
        ...
        channel_primary_image_tag: None | Unset | str
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_etag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_date_created(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_date_last_media_added(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        date_last_media_added = _parse_date_last_media_added(d.pop("DateLastMediaAdded", UNSET))

        def _parse_extra_type(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        extra_type = _parse_extra_type(d.pop("ExtraType", UNSET))

        def _parse_airs_before_season_number(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        airs_before_season_number = _parse_airs_before_season_number(d.pop("AirsBeforeSeasonNumber", UNSET))

        def _parse_airs_after_season_number(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        airs_after_season_number = _parse_airs_after_season_number(d.pop("AirsAfterSeasonNumber", UNSET))

        def _parse_airs_before_episode_number(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        airs_before_episode_number = _parse_airs_before_episode_number(d.pop("AirsBeforeEpisodeNumber", UNSET))

        def _parse_can_delete(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_can_download(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_has_subtitles(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_preferred_metadata_country_code(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        preferred_metadata_country_code = _parse_preferred_metadata_country_code(d.pop("PreferredMetadataCountryCode", UNSET))

        def _parse_supports_sync(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_sort_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_forced_sort_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_external_urls(data: object) -> list["ExternalUrl"] | None | Unset:
            ...
            try:
                ...
                for external_urls_type_0_item_data in _external_urls_type_0:
                    external_urls_type_0_item = ExternalUrl.from_dict(external_urls_type_0_item_data)
        ...
        def _parse_media_sources(data: object) -> list["MediaSourceInfo"] | None | Unset:
            ...
            try:
                ...
                for media_sources_type_0_item_data in _media_sources_type_0:
                    media_sources_type_0_item = MediaSourceInfo.from_dict(media_sources_type_0_item_data)
        ...
        def _parse_critic_rating(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        production_locations = _parse_production_locations(d.pop("ProductionLocations", UNSET))
        ...
        def _parse_enable_media_source_display(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        enable_media_source_display = _parse_enable_media_source_display(d.pop("EnableMediaSourceDisplay", UNSET))

        def _parse_official_rating(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_custom_rating(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_overview(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_cumulative_run_time_ticks(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        cumulative_run_time_ticks = _parse_cumulative_run_time_ticks(d.pop("CumulativeRunTimeTicks", UNSET))
        ...
        def _parse_play_access(data: object) -> None | PlayAccess | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                play_access_type_1 = PlayAccess(data)

                return play_access_type_1
            except:  # noqa: E722
                pass
            return cast(None | PlayAccess | Unset, data)

        play_access = _parse_play_access(d.pop("PlayAccess", UNSET))
        ...
        def _parse_is_place_holder(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_number(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_channel_number(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_index_number_end(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_provider_ids(data: object) -> Union["BaseItemDtoProviderIdsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_hd(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_people(data: object) -> list["BaseItemPerson"] | None | Unset:
            ...
            try:
                ...
                for people_type_0_item_data in _people_type_0:
                    people_type_0_item = BaseItemPerson.from_dict(people_type_0_item_data)
        ...
        def _parse_studios(data: object) -> list["NameGuidPair"] | None | Unset:
            ...
            try:
                ...
                for studios_type_0_item_data in _studios_type_0:
                    studios_type_0_item = NameGuidPair.from_dict(studios_type_0_item_data)
        ...
        def _parse_genre_items(data: object) -> list["NameGuidPair"] | None | Unset:
            ...
            try:
                ...
                for genre_items_type_0_item_data in _genre_items_type_0:
                    genre_items_type_0_item = NameGuidPair.from_dict(genre_items_type_0_item_data)
        ...
        def _parse_parent_logo_item_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        parent_logo_item_id = _parse_parent_logo_item_id(d.pop("ParentLogoItemId", UNSET))

        def _parse_parent_backdrop_item_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_local_trailer_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        local_trailer_count = _parse_local_trailer_count(d.pop("LocalTrailerCount", UNSET))
        ...
        def _parse_recursive_item_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        recursive_item_count = _parse_recursive_item_count(d.pop("RecursiveItemCount", UNSET))

        def _parse_child_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_series_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_series_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_season_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_special_feature_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        special_feature_count = _parse_special_feature_count(d.pop("SpecialFeatureCount", UNSET))

        def _parse_display_preferences_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        display_preferences_id = _parse_display_preferences_id(d.pop("DisplayPreferencesId", UNSET))
        ...
        def _parse_air_time(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_artist_items(data: object) -> list["NameGuidPair"] | None | Unset:
            ...
            try:
                ...
                for artist_items_type_0_item_data in _artist_items_type_0:
                    artist_items_type_0_item = NameGuidPair.from_dict(artist_items_type_0_item_data)
        ...
        def _parse_collection_type(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_display_order(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_album_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_album_primary_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        album_primary_image_tag = _parse_album_primary_image_tag(d.pop("AlbumPrimaryImageTag", UNSET))

        def _parse_series_primary_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        series_primary_image_tag = _parse_series_primary_image_tag(d.pop("SeriesPrimaryImageTag", UNSET))
        ...
        def _parse_album_artists(data: object) -> list["NameGuidPair"] | None | Unset:
            ...
            try:
                ...
                for album_artists_type_0_item_data in _album_artists_type_0:
                    album_artists_type_0_item = NameGuidPair.from_dict(album_artists_type_0_item_data)
        ...
        def _parse_season_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_part_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_media_source_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_image_tags(data: object) -> Union["BaseItemDtoImageTagsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        backdrop_image_tags = _parse_backdrop_image_tags(d.pop("BackdropImageTags", UNSET))
        ...
        screenshot_image_tags = _parse_screenshot_image_tags(d.pop("ScreenshotImageTags", UNSET))

        def _parse_parent_logo_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        parent_logo_image_tag = _parse_parent_logo_image_tag(d.pop("ParentLogoImageTag", UNSET))

        def _parse_parent_art_item_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_art_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        parent_art_image_tag = _parse_parent_art_image_tag(d.pop("ParentArtImageTag", UNSET))

        def _parse_series_thumb_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        series_thumb_image_tag = _parse_series_thumb_image_tag(d.pop("SeriesThumbImageTag", UNSET))

        def _parse_image_blur_hashes(data: object) -> Union["BaseItemDtoImageBlurHashesType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                image_blur_hashes_type_0 = BaseItemDtoImageBlurHashesType0.from_dict(data)
        ...
        def _parse_series_studio(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_thumb_item_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_thumb_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_primary_image_item_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_parent_primary_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_chapters(data: object) -> list["ChapterInfo"] | None | Unset:
            ...
            try:
                ...
                for chapters_type_0_item_data in _chapters_type_0:
                    chapters_type_0_item = ChapterInfo.from_dict(chapters_type_0_item_data)
        ...
        def _parse_locked_fields(data: object) -> list[MetadataField] | None | Unset:
            ...
            try:
                ...
                for locked_fields_type_0_item_data in _locked_fields_type_0:
                    locked_fields_type_0_item = MetadataField(locked_fields_type_0_item_data)
        ...
        def _parse_trailer_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_movie_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_series_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_program_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_album_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_artist_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_music_video_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_lock_data(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_camera_make(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_camera_model(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_software(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_exposure_time(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_focal_length(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_image_orientation(data: object) -> ImageOrientation | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                image_orientation_type_1 = ImageOrientation(data)

                return image_orientation_type_1
            except:  # noqa: E722
                pass
            return cast(ImageOrientation | None | Unset, data)

        image_orientation = _parse_image_orientation(d.pop("ImageOrientation", UNSET))

        def _parse_aperture(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_shutter_speed(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_latitude(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_longitude(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_altitude(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_iso_speed_rating(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_series_timer_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_channel_primary_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_completion_percentage(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        completion_percentage = _parse_completion_percentage(d.pop("CompletionPercentage", UNSET))

        def _parse_is_repeat(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_episode_title(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_channel_type(data: object) -> ChannelType | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                channel_type_type_1 = ChannelType(data)

                return channel_type_type_1
            except:  # noqa: E722
                pass
            return cast(ChannelType | None | Unset, data)

        channel_type = _parse_channel_type(d.pop("ChannelType", UNSET))

        def _parse_audio(data: object) -> None | ProgramAudio | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                audio_type_1 = ProgramAudio(data)

                return audio_type_1
            except:  # noqa: E722
                pass
            return cast(None | ProgramAudio | Unset, data)

        audio = _parse_audio(d.pop("Audio", UNSET))

        def _parse_is_movie(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_sports(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_series(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_live(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_news(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_kids(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_premiere(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_timer_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
