...
class PlaybackInfoDto:
    ...
    enable_direct_play: None | Unset | bool = UNSET
    enable_direct_stream: None | Unset | bool = UNSET
    enable_transcoding: None | Unset | bool = UNSET
    allow_video_stream_copy: None | Unset | bool = UNSET
    allow_audio_stream_copy: None | Unset | bool = UNSET
    auto_open_live_stream: None | Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        start_time_ticks: None | Unset | int
        ...
        max_audio_channels: None | Unset | int
        ...
        allow_audio_stream_copy: None | Unset | bool
        ...
        auto_open_live_stream: None | Unset | bool
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_start_time_ticks(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_max_audio_channels(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_direct_play(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_direct_stream(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        enable_direct_stream = _parse_enable_direct_stream(d.pop("EnableDirectStream", UNSET))

        def _parse_enable_transcoding(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        enable_transcoding = _parse_enable_transcoding(d.pop("EnableTranscoding", UNSET))

        def _parse_allow_video_stream_copy(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        allow_video_stream_copy = _parse_allow_video_stream_copy(d.pop("AllowVideoStreamCopy", UNSET))

        def _parse_allow_audio_stream_copy(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        allow_audio_stream_copy = _parse_allow_audio_stream_copy(d.pop("AllowAudioStreamCopy", UNSET))

        def _parse_auto_open_live_stream(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        auto_open_live_stream = _parse_auto_open_live_stream(d.pop("AutoOpenLiveStream", UNSET))
