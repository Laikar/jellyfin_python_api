...
class LibraryOptions:
    ...
    enable_photos: Unset | bool = UNSET
    enable_realtime_monitor: Unset | bool = UNSET
    enable_chapter_image_extraction: Unset | bool = UNSET
    extract_chapter_images_during_library_scan: Unset | bool = UNSET
    path_infos: Unset | list["MediaPathInfo"] = UNSET
    save_local_metadata: Unset | bool = UNSET
    enable_internet_providers: Unset | bool = UNSET
    enable_automatic_series_grouping: Unset | bool = UNSET
    enable_embedded_titles: Unset | bool = UNSET
    enable_embedded_episode_infos: Unset | bool = UNSET
    automatic_refresh_interval_days: Unset | int = UNSET
    preferred_metadata_language: None | Unset | str = UNSET
    metadata_country_code: None | Unset | str = UNSET
    season_zero_display_name: Unset | str = UNSET
    metadata_savers: list[str] | None | Unset = UNSET
    disabled_local_metadata_readers: Unset | list[str] = UNSET
    local_metadata_reader_order: list[str] | None | Unset = UNSET
    disabled_subtitle_fetchers: Unset | list[str] = UNSET
    subtitle_fetcher_order: Unset | list[str] = UNSET
    skip_subtitles_if_embedded_subtitles_present: Unset | bool = UNSET
    skip_subtitles_if_audio_track_matches: Unset | bool = UNSET
    subtitle_download_languages: list[str] | None | Unset = UNSET
    require_perfect_subtitle_match: Unset | bool = UNSET
    save_subtitles_with_media: Unset | bool = UNSET
    automatically_add_to_collection: Unset | bool = UNSET
    allow_embedded_subtitles: Unset | EmbeddedSubtitleOptions = UNSET
    type_options: Unset | list["TypeOptions"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        path_infos: Unset | list[dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_local_metadata_reader_order(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        local_metadata_reader_order = _parse_local_metadata_reader_order(d.pop("LocalMetadataReaderOrder", UNSET))
        ...
        def _parse_subtitle_download_languages(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        subtitle_download_languages = _parse_subtitle_download_languages(d.pop("SubtitleDownloadLanguages", UNSET))
        ...
        allow_embedded_subtitles: Unset | EmbeddedSubtitleOptions
