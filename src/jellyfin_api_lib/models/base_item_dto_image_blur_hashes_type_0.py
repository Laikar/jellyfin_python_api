...
if TYPE_CHECKING:
    from ..models.base_item_dto_image_blur_hashes_type_0_art import BaseItemDtoImageBlurHashesType0Art
    from ..models.base_item_dto_image_blur_hashes_type_0_backdrop import BaseItemDtoImageBlurHashesType0Backdrop
    from ..models.base_item_dto_image_blur_hashes_type_0_banner import BaseItemDtoImageBlurHashesType0Banner
    from ..models.base_item_dto_image_blur_hashes_type_0_box import BaseItemDtoImageBlurHashesType0Box
    from ..models.base_item_dto_image_blur_hashes_type_0_box_rear import BaseItemDtoImageBlurHashesType0BoxRear
    from ..models.base_item_dto_image_blur_hashes_type_0_chapter import BaseItemDtoImageBlurHashesType0Chapter
    from ..models.base_item_dto_image_blur_hashes_type_0_disc import BaseItemDtoImageBlurHashesType0Disc
    from ..models.base_item_dto_image_blur_hashes_type_0_logo import BaseItemDtoImageBlurHashesType0Logo
    from ..models.base_item_dto_image_blur_hashes_type_0_menu import BaseItemDtoImageBlurHashesType0Menu
    from ..models.base_item_dto_image_blur_hashes_type_0_primary import BaseItemDtoImageBlurHashesType0Primary
    from ..models.base_item_dto_image_blur_hashes_type_0_profile import BaseItemDtoImageBlurHashesType0Profile
    from ..models.base_item_dto_image_blur_hashes_type_0_screenshot import BaseItemDtoImageBlurHashesType0Screenshot
    from ..models.base_item_dto_image_blur_hashes_type_0_thumb import BaseItemDtoImageBlurHashesType0Thumb
...
class BaseItemDtoImageBlurHashesType0:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        primary: Unset | BaseItemDtoImageBlurHashesType0Primary
        ...
        art: Unset | BaseItemDtoImageBlurHashesType0Art
        ...
        backdrop: Unset | BaseItemDtoImageBlurHashesType0Backdrop
        ...
        banner: Unset | BaseItemDtoImageBlurHashesType0Banner
        ...
        logo: Unset | BaseItemDtoImageBlurHashesType0Logo
        ...
        thumb: Unset | BaseItemDtoImageBlurHashesType0Thumb
        ...
        disc: Unset | BaseItemDtoImageBlurHashesType0Disc
        ...
        box: Unset | BaseItemDtoImageBlurHashesType0Box
        ...
        screenshot: Unset | BaseItemDtoImageBlurHashesType0Screenshot
        if isinstance(_screenshot, Unset):
            screenshot = UNSET
        else:
            screenshot = BaseItemDtoImageBlurHashesType0Screenshot.from_dict(_screenshot)

        _menu = d.pop("Menu", UNSET)
        menu: Unset | BaseItemDtoImageBlurHashesType0Menu
        ...
        chapter: Unset | BaseItemDtoImageBlurHashesType0Chapter
        ...
        box_rear: Unset | BaseItemDtoImageBlurHashesType0BoxRear
        ...
        profile: Unset | BaseItemDtoImageBlurHashesType0Profile
