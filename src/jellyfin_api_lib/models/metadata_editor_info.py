...
class MetadataEditorInfo:
    ...
    parental_rating_options: Unset | list["ParentalRating"] = UNSET
    countries: Unset | list["CountryInfo"] = UNSET
    cultures: Unset | list["CultureDto"] = UNSET
    external_id_infos: Unset | list["ExternalIdInfo"] = UNSET
    content_type: None | Unset | str = UNSET
    content_type_options: Unset | list["NameValuePair"] = UNSET

    def to_dict(self) -> dict[str, Any]:
        parental_rating_options: Unset | list[dict[str, Any]] = UNSET
        ...
        cultures: Unset | list[dict[str, Any]] = UNSET
        ...
        external_id_infos: Unset | list[dict[str, Any]] = UNSET
        ...
        content_type_options: Unset | list[dict[str, Any]] = UNSET
