...
class LibraryTypeOptionsDto:
    ...
    metadata_fetchers: Unset | list["LibraryOptionInfoDto"] = UNSET
    image_fetchers: Unset | list["LibraryOptionInfoDto"] = UNSET
    supported_image_types: Unset | list[ImageType] = UNSET
    default_image_options: Unset | list["ImageOption"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        metadata_fetchers: Unset | list[dict[str, Any]] = UNSET
        ...
        image_fetchers: Unset | list[dict[str, Any]] = UNSET
        ...
        supported_image_types: Unset | list[str] = UNSET
        ...
        default_image_options: Unset | list[dict[str, Any]] = UNSET
