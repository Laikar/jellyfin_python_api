...
class DeviceIdentification:
    ...
    friendly_name: Unset | str = UNSET
    model_number: Unset | str = UNSET
    serial_number: Unset | str = UNSET
    model_name: Unset | str = UNSET
    model_description: Unset | str = UNSET
    model_url: Unset | str = UNSET
    manufacturer: Unset | str = UNSET
    manufacturer_url: Unset | str = UNSET
    headers: Unset | list["HttpHeaderInfo"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        headers: Unset | list[dict[str, Any]] = UNSET
