...
class ChapterInfo:
    ...
    start_position_ticks: Unset | int = UNSET
    name: None | Unset | str = UNSET
    image_path: None | Unset | str = UNSET
    image_date_modified: Unset | datetime.datetime = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        image_path: None | Unset | str
        if isinstance(self.image_path, Unset):
            image_path = UNSET
        else:
            image_path = self.image_path

        image_date_modified: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_image_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        image_date_modified: Unset | datetime.datetime
