...
class DlnaOptions:
    ...
    Attributes:
        ...
        default_user_id (Union[None, Unset, str]): Gets or sets the default user account that the dlna server uses.
    ...
    enable_play_to: Unset | bool = UNSET
    enable_server: Unset | bool = UNSET
    enable_debug_log: Unset | bool = UNSET
    enable_play_to_tracing: Unset | bool = UNSET
    client_discovery_interval_seconds: Unset | int = UNSET
    alive_message_interval_seconds: Unset | int = UNSET
    blast_alive_message_interval_seconds: Unset | int = UNSET
    default_user_id: None | Unset | str = UNSET
    auto_create_play_to_profiles: Unset | bool = UNSET
    blast_alive_messages: Unset | bool = UNSET
    send_only_matched_host: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        default_user_id: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_default_user_id(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        default_user_id = _parse_default_user_id(d.pop("DefaultUserId", UNSET))
