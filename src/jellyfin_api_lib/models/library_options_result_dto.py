...
class LibraryOptionsResultDto:
    ...
    metadata_savers: Unset | list["LibraryOptionInfoDto"] = UNSET
    metadata_readers: Unset | list["LibraryOptionInfoDto"] = UNSET
    subtitle_fetchers: Unset | list["LibraryOptionInfoDto"] = UNSET
    type_options: Unset | list["LibraryTypeOptionsDto"] = UNSET

    def to_dict(self) -> dict[str, Any]:
        metadata_savers: Unset | list[dict[str, Any]] = UNSET
        ...
        metadata_readers: Unset | list[dict[str, Any]] = UNSET
        ...
        subtitle_fetchers: Unset | list[dict[str, Any]] = UNSET
