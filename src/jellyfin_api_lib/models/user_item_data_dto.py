...
class UserItemDataDto:
    ...
    rating: None | Unset | float = UNSET
    played_percentage: None | Unset | float = UNSET
    unplayed_item_count: None | Unset | int = UNSET
    playback_position_ticks: Unset | int = UNSET
    play_count: Unset | int = UNSET
    is_favorite: Unset | bool = UNSET
    likes: None | Unset | bool = UNSET
    last_played_date: None | Unset | datetime.datetime = UNSET
    played: Unset | bool = UNSET
    key: None | Unset | str = UNSET
    item_id: None | Unset | str = UNSET

    def to_dict(self) -> dict[str, Any]:
        rating: None | Unset | float
        if isinstance(self.rating, Unset):
            rating = UNSET
        else:
            rating = self.rating

        played_percentage: None | Unset | float
        if isinstance(self.played_percentage, Unset):
            played_percentage = UNSET
        else:
            played_percentage = self.played_percentage

        unplayed_item_count: None | Unset | int
        ...
        likes: None | Unset | bool
        if isinstance(self.likes, Unset):
            likes = UNSET
        else:
            likes = self.likes

        last_played_date: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_rating(data: object) -> None | Unset | float:
            if data is None:
                return data
        ...
        def _parse_played_percentage(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_unplayed_item_count(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_likes(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_last_played_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
