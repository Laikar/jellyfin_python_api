...
class CountryInfo:
    ...
    two_letter_iso_region_name: None | Unset | str = UNSET
    three_letter_iso_region_name: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        two_letter_iso_region_name: None | Unset | str
        ...
        three_letter_iso_region_name: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_two_letter_iso_region_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_three_letter_iso_region_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
