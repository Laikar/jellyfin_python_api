...
class UserPolicy:
    ...
    Attributes:
        ...
        authentication_provider_id (Union[None, Unset, str]):
        password_reset_provider_id (Union[None, Unset, str]):
        sync_play_access (Union[Unset, SyncPlayUserAccessType]): Enum SyncPlayUserAccessType.
    """

    is_administrator: Unset | bool = UNSET
    is_hidden: Unset | bool = UNSET
    is_disabled: Unset | bool = UNSET
    max_parental_rating: None | Unset | int = UNSET
    blocked_tags: list[str] | None | Unset = UNSET
    enable_user_preference_access: Unset | bool = UNSET
    access_schedules: list["AccessSchedule"] | None | Unset = UNSET
    block_unrated_items: list[UnratedItem] | None | Unset = UNSET
    enable_remote_control_of_other_users: Unset | bool = UNSET
    enable_shared_device_control: Unset | bool = UNSET
    enable_remote_access: Unset | bool = UNSET
    enable_live_tv_management: Unset | bool = UNSET
    enable_live_tv_access: Unset | bool = UNSET
    enable_media_playback: Unset | bool = UNSET
    enable_audio_playback_transcoding: Unset | bool = UNSET
    enable_video_playback_transcoding: Unset | bool = UNSET
    enable_playback_remuxing: Unset | bool = UNSET
    force_remote_source_transcoding: Unset | bool = UNSET
    enable_content_deletion: Unset | bool = UNSET
    enable_content_deletion_from_folders: list[str] | None | Unset = UNSET
    enable_content_downloading: Unset | bool = UNSET
    enable_sync_transcoding: Unset | bool = UNSET
    enable_media_conversion: Unset | bool = UNSET
    enabled_devices: list[str] | None | Unset = UNSET
    enable_all_devices: Unset | bool = UNSET
    enabled_channels: list[str] | None | Unset = UNSET
    enable_all_channels: Unset | bool = UNSET
    enabled_folders: list[str] | None | Unset = UNSET
    enable_all_folders: Unset | bool = UNSET
    invalid_login_attempt_count: Unset | int = UNSET
    login_attempts_before_lockout: Unset | int = UNSET
    max_active_sessions: Unset | int = UNSET
    enable_public_sharing: Unset | bool = UNSET
    blocked_media_folders: list[str] | None | Unset = UNSET
    blocked_channels: list[str] | None | Unset = UNSET
    remote_client_bitrate_limit: Unset | int = UNSET
    authentication_provider_id: None | Unset | str = UNSET
    password_reset_provider_id: None | Unset | str = UNSET
    sync_play_access: Unset | SyncPlayUserAccessType = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        max_parental_rating: None | Unset | int
        ...
        if isinstance(self.access_schedules, Unset):
            ...
            for access_schedules_type_0_item_data in self.access_schedules:
                access_schedules_type_0_item = access_schedules_type_0_item_data.to_dict()
        ...
        if isinstance(self.block_unrated_items, Unset):
            ...
            for block_unrated_items_type_0_item_data in self.block_unrated_items:
                block_unrated_items_type_0_item = block_unrated_items_type_0_item_data.value
        ...
        authentication_provider_id: None | Unset | str
        if isinstance(self.authentication_provider_id, Unset):
            authentication_provider_id = UNSET
        else:
            authentication_provider_id = self.authentication_provider_id

        password_reset_provider_id: None | Unset | str
        if isinstance(self.password_reset_provider_id, Unset):
            password_reset_provider_id = UNSET
        else:
            password_reset_provider_id = self.password_reset_provider_id

        sync_play_access: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_max_parental_rating(data: object) -> None | Unset | int:
            if data is None:
                return data
        ...
        max_parental_rating = _parse_max_parental_rating(d.pop("MaxParentalRating", UNSET))
        ...
        def _parse_access_schedules(data: object) -> list["AccessSchedule"] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for access_schedules_type_0_item_data in _access_schedules_type_0:
                    access_schedules_type_0_item = AccessSchedule.from_dict(access_schedules_type_0_item_data)
        ...
        def _parse_block_unrated_items(data: object) -> list[UnratedItem] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for block_unrated_items_type_0_item_data in _block_unrated_items_type_0:
                    block_unrated_items_type_0_item = UnratedItem(block_unrated_items_type_0_item_data)
        ...
        block_unrated_items = _parse_block_unrated_items(d.pop("BlockUnratedItems", UNSET))
        ...
        def _parse_enable_content_deletion_from_folders(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        enable_content_deletion_from_folders = _parse_enable_content_deletion_from_folders(d.pop("EnableContentDeletionFromFolders", UNSET))
        ...
        def _parse_enabled_channels(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enabled_folders(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blocked_media_folders(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        blocked_media_folders = _parse_blocked_media_folders(d.pop("BlockedMediaFolders", UNSET))

        def _parse_blocked_channels(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_authentication_provider_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        authentication_provider_id = _parse_authentication_provider_id(d.pop("AuthenticationProviderId", UNSET))

        def _parse_password_reset_provider_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        password_reset_provider_id = _parse_password_reset_provider_id(d.pop("PasswordResetProviderId", UNSET))

        _sync_play_access = d.pop("SyncPlayAccess", UNSET)
        sync_play_access: Unset | SyncPlayUserAccessType
