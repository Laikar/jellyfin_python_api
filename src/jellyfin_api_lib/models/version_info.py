...
class VersionInfo:
    ...
    version_number: Unset | str = UNSET
    changelog: None | Unset | str = UNSET
    target_abi: None | Unset | str = UNSET
    source_url: None | Unset | str = UNSET
    checksum: None | Unset | str = UNSET
    timestamp: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        changelog: None | Unset | str
        if isinstance(self.changelog, Unset):
            changelog = UNSET
        else:
            changelog = self.changelog

        target_abi: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_changelog(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_target_abi(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_checksum(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_timestamp(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
