...
class ItemCounts:
    ...
    movie_count: Unset | int = UNSET
    series_count: Unset | int = UNSET
    episode_count: Unset | int = UNSET
    artist_count: Unset | int = UNSET
    program_count: Unset | int = UNSET
    trailer_count: Unset | int = UNSET
    song_count: Unset | int = UNSET
    album_count: Unset | int = UNSET
    music_video_count: Unset | int = UNSET
    box_set_count: Unset | int = UNSET
    book_count: Unset | int = UNSET
    item_count: Unset | int = UNSET
