...
class MetadataOptions:
    ...
    item_type: None | Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_item_type(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        disabled_metadata_savers = _parse_disabled_metadata_savers(d.pop("DisabledMetadataSavers", UNSET))
        ...
        disabled_metadata_fetchers = _parse_disabled_metadata_fetchers(d.pop("DisabledMetadataFetchers", UNSET))
        ...
        metadata_fetcher_order = _parse_metadata_fetcher_order(d.pop("MetadataFetcherOrder", UNSET))
        ...
        disabled_image_fetchers = _parse_disabled_image_fetchers(d.pop("DisabledImageFetchers", UNSET))
        ...
        image_fetcher_order = _parse_image_fetcher_order(d.pop("ImageFetcherOrder", UNSET))
