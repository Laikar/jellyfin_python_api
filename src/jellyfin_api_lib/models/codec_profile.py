...
class CodecProfile:
    ...
    type: Unset | CodecType = UNSET
    conditions: list["ProfileCondition"] | None | Unset = UNSET
    apply_conditions: list["ProfileCondition"] | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        apply_conditions: list[dict[str, Any]] | None | Unset
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_apply_conditions(data: object) -> list["ProfileCondition"] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
