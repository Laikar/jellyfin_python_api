...
class ChannelFeatures:
    ...
    id: Unset | str = UNSET
    can_search: Unset | bool = UNSET
    media_types: Unset | list[ChannelMediaType] = UNSET
    content_types: Unset | list[ChannelMediaContentType] = UNSET
    max_page_size: None | Unset | int = UNSET
    auto_refresh_levels: None | Unset | int = UNSET
    default_sort_fields: Unset | list[ChannelItemSortField] = UNSET
    supports_sort_order_toggle: Unset | bool = UNSET
    supports_latest_media: Unset | bool = UNSET
    can_filter: Unset | bool = UNSET
    supports_content_downloading: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        content_types: Unset | list[str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_max_page_size(data: object) -> None | Unset | int:
            if data is None:
                return data
        ...
        def _parse_auto_refresh_levels(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        auto_refresh_levels = _parse_auto_refresh_levels(d.pop("AutoRefreshLevels", UNSET))
