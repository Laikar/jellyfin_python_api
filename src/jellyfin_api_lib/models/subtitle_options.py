...
class SubtitleOptions:
    ...
    skip_if_embedded_subtitles_present: Unset | bool = UNSET
    skip_if_audio_track_matches: Unset | bool = UNSET
    download_languages: list[str] | None | Unset = UNSET
    download_movie_subtitles: Unset | bool = UNSET
    download_episode_subtitles: Unset | bool = UNSET
    open_subtitles_username: None | Unset | str = UNSET
    open_subtitles_password_hash: None | Unset | str = UNSET
    is_open_subtitle_vip_account: Unset | bool = UNSET
    require_perfect_match: Unset | bool = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        open_subtitles_username: None | Unset | str
        ...
        open_subtitles_password_hash: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_open_subtitles_username(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_open_subtitles_password_hash(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
