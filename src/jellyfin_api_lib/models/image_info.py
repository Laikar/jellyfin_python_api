...
class ImageInfo:
    ...
    image_type: Unset | ImageType = UNSET
    image_index: None | Unset | int = UNSET
    image_tag: None | Unset | str = UNSET
    path: None | Unset | str = UNSET
    blur_hash: None | Unset | str = UNSET
    height: None | Unset | int = UNSET
    width: None | Unset | int = UNSET
    size: Unset | int = UNSET

    def to_dict(self) -> dict[str, Any]:
        image_type: Unset | str = UNSET
        if not isinstance(self.image_type, Unset):
            image_type = self.image_type.value

        image_index: None | Unset | int
        if isinstance(self.image_index, Unset):
            image_index = UNSET
        else:
            image_index = self.image_index

        image_tag: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        image_type: Unset | ImageType
        if isinstance(_image_type, Unset):
            image_type = UNSET
        else:
            image_type = ImageType(_image_type)

        def _parse_image_index(data: object) -> None | Unset | int:
            if data is None:
                return data
        ...
        def _parse_image_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_blur_hash(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
