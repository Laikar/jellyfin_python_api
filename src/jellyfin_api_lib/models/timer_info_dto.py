...
class TimerInfoDto:
    ...
    status: Unset | RecordingStatus = UNSET
    series_timer_id: None | Unset | str = UNSET
    external_series_timer_id: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        external_series_timer_id: None | Unset | str
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_external_series_timer_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        external_series_timer_id = _parse_external_series_timer_id(d.pop("ExternalSeriesTimerId", UNSET))
