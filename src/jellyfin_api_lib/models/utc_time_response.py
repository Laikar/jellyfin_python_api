...
class UtcTimeResponse:
    ...
    request_reception_time: Unset | datetime.datetime = UNSET
    response_transmission_time: Unset | datetime.datetime = UNSET

    def to_dict(self) -> dict[str, Any]:
        request_reception_time: Unset | str = UNSET
        if not isinstance(self.request_reception_time, Unset):
            request_reception_time = self.request_reception_time.isoformat()

        response_transmission_time: Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        request_reception_time: Unset | datetime.datetime
        ...
        response_transmission_time: Unset | datetime.datetime
