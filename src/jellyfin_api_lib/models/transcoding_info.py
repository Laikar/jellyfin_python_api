...
class TranscodingInfo:
    ...
    Attributes:
        ...
        hardware_acceleration_type (Union[HardwareEncodingType, None, Unset]):
    ...
    is_video_direct: Unset | bool = UNSET
    is_audio_direct: Unset | bool = UNSET
    bitrate: None | Unset | int = UNSET
    framerate: None | Unset | float = UNSET
    completion_percentage: None | Unset | float = UNSET
    width: None | Unset | int = UNSET
    height: None | Unset | int = UNSET
    audio_channels: None | Unset | int = UNSET
    hardware_acceleration_type: HardwareEncodingType | None | Unset = UNSET
    transcode_reasons: Unset | list[TranscodeReason] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.hardware_acceleration_type, HardwareEncodingType):
        ...
        transcode_reasons: Unset | list[str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_framerate(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_audio_channels(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_hardware_acceleration_type(data: object) -> HardwareEncodingType | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                hardware_acceleration_type_type_1 = HardwareEncodingType(data)

                return hardware_acceleration_type_type_1
            except:  # noqa: E722
                pass
            return cast(HardwareEncodingType | None | Unset, data)
