...
class UserDto:
    ...
    has_password: Unset | bool = UNSET
    has_configured_password: Unset | bool = UNSET
    has_configured_easy_password: Unset | bool = UNSET
    enable_auto_login: None | Unset | bool = UNSET
    last_login_date: None | Unset | datetime.datetime = UNSET
    last_activity_date: None | Unset | datetime.datetime = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        last_activity_date: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_enable_auto_login(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_last_login_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_last_activity_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_configuration(data: object) -> Union["UserConfiguration", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
