...
class SubtitleProfile:
    ...
    method: Unset | SubtitleDeliveryMethod = UNSET
    didl_mode: None | Unset | str = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        method: Unset | SubtitleDeliveryMethod
        if isinstance(_method, Unset):
            method = UNSET
        else:
            method = SubtitleDeliveryMethod(_method)

        def _parse_didl_mode(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
