...
class NetworkConfiguration:
    ...
    require_https: Unset | bool = UNSET
    certificate_path: Unset | str = UNSET
    certificate_password: Unset | str = UNSET
    base_url: Unset | str = UNSET
    public_https_port: Unset | int = UNSET
    http_server_port_number: Unset | int = UNSET
    https_port_number: Unset | int = UNSET
    enable_https: Unset | bool = UNSET
    public_port: Unset | int = UNSET
    u_pn_p_create_http_port_map: Unset | bool = UNSET
    udp_port_range: Unset | str = UNSET
    enable_ipv6: Unset | bool = UNSET
    enable_ipv4: Unset | bool = UNSET
    enable_ssdp_tracing: Unset | bool = UNSET
    ssdp_tracing_filter: Unset | str = UNSET
    udp_send_count: Unset | int = UNSET
    udp_send_delay: Unset | int = UNSET
    ignore_virtual_interfaces: Unset | bool = UNSET
    virtual_interface_names: Unset | str = UNSET
    gateway_monitor_period: Unset | int = UNSET
    enable_multi_socket_binding: Unset | bool = UNSET
    trust_all_ip6_interfaces: Unset | bool = UNSET
    hd_homerun_port_range: Unset | str = UNSET
    published_server_uri_by_subnet: Unset | list[str] = UNSET
    auto_discovery_tracing: Unset | bool = UNSET
    auto_discovery: Unset | bool = UNSET
    remote_ip_filter: Unset | list[str] = UNSET
    is_remote_ip_filter_blacklist: Unset | bool = UNSET
    enable_u_pn_p: Unset | bool = UNSET
    enable_remote_access: Unset | bool = UNSET
    local_network_subnets: Unset | list[str] = UNSET
    local_network_addresses: Unset | list[str] = UNSET
    known_proxies: Unset | list[str] = UNSET
    enable_published_server_uri_by_request: Unset | bool = UNSET
