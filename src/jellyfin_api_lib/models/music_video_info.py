...
if TYPE_CHECKING:
    from ..models.music_video_info_provider_ids_type_0 import MusicVideoInfoProviderIdsType0
...
class MusicVideoInfo:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_provider_ids(data: object) -> Union["MusicVideoInfoProviderIdsType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
