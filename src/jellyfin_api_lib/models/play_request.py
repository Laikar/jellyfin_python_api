...
class PlayRequest:
    ...
    start_position_ticks: None | Unset | int = UNSET
    play_command: Unset | PlayCommand = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_item_ids(data: object) -> list[str] | None | Unset:
            if data is None:
                return data
        ...
        def _parse_start_position_ticks(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        start_position_ticks = _parse_start_position_ticks(d.pop("StartPositionTicks", UNSET))

        _play_command = d.pop("PlayCommand", UNSET)
        play_command: Unset | PlayCommand
