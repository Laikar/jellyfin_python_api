...
class SystemInfo:
    ...
    local_address: None | Unset | str = UNSET
    server_name: None | Unset | str = UNSET
    version: None | Unset | str = UNSET
    product_name: None | Unset | str = UNSET
    operating_system: None | Unset | str = UNSET
    id: None | Unset | str = UNSET
    startup_wizard_completed: None | Unset | bool = UNSET
    operating_system_display_name: None | Unset | str = UNSET
    package_name: None | Unset | str = UNSET
    has_pending_restart: Unset | bool = UNSET
    is_shutting_down: Unset | bool = UNSET
    supports_library_monitor: Unset | bool = UNSET
    web_socket_port_number: Unset | int = UNSET
    completed_installations: list["InstallationInfo"] | None | Unset = UNSET
    can_self_restart: Unset | bool = UNSET
    can_launch_web_browser: Unset | bool = UNSET
    program_data_path: None | Unset | str = UNSET
    web_path: None | Unset | str = UNSET
    items_by_name_path: None | Unset | str = UNSET
    cache_path: None | Unset | str = UNSET
    log_path: None | Unset | str = UNSET
    internal_metadata_path: None | Unset | str = UNSET
    transcoding_temp_path: None | Unset | str = UNSET
    has_update_available: Unset | bool = UNSET
    encoder_location: Unset | FFmpegLocation = UNSET
    system_architecture: Unset | Architecture = UNSET

    def to_dict(self) -> dict[str, Any]:
        local_address: None | Unset | str
        ...
        operating_system: None | Unset | str
        ...
        startup_wizard_completed: None | Unset | bool
        ...
        operating_system_display_name: None | Unset | str
        ...
        log_path: None | Unset | str
        if isinstance(self.log_path, Unset):
            log_path = UNSET
        else:
            log_path = self.log_path

        internal_metadata_path: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_local_address(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_operating_system(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_startup_wizard_completed(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_operating_system_display_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_package_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_completed_installations(data: object) -> list["InstallationInfo"] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for completed_installations_type_0_item_data in _completed_installations_type_0:
                    completed_installations_type_0_item = InstallationInfo.from_dict(completed_installations_type_0_item_data)
        ...
        def _parse_program_data_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_web_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_items_by_name_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_log_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_internal_metadata_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        encoder_location: Unset | FFmpegLocation
        ...
        system_architecture: Unset | Architecture
