...
class MediaStream:
    ...
    Attributes:
        ...
        video_range (Union[None, Unset, str]): Gets the video range.
        video_range_type (Union[None, Unset, str]): Gets the video range type.
        ...
        delivery_method (Union[None, SubtitleDeliveryMethod, Unset]): Gets or sets the method.
    ...
    codec: None | Unset | str = UNSET
    codec_tag: None | Unset | str = UNSET
    language: None | Unset | str = UNSET
    color_range: None | Unset | str = UNSET
    color_space: None | Unset | str = UNSET
    color_transfer: None | Unset | str = UNSET
    color_primaries: None | Unset | str = UNSET
    dv_version_major: None | Unset | int = UNSET
    dv_version_minor: None | Unset | int = UNSET
    dv_profile: None | Unset | int = UNSET
    dv_level: None | Unset | int = UNSET
    rpu_present_flag: None | Unset | int = UNSET
    el_present_flag: None | Unset | int = UNSET
    bl_present_flag: None | Unset | int = UNSET
    dv_bl_signal_compatibility_id: None | Unset | int = UNSET
    comment: None | Unset | str = UNSET
    time_base: None | Unset | str = UNSET
    codec_time_base: None | Unset | str = UNSET
    title: None | Unset | str = UNSET
    video_range: None | Unset | str = UNSET
    video_range_type: None | Unset | str = UNSET
    video_do_vi_title: None | Unset | str = UNSET
    localized_undefined: None | Unset | str = UNSET
    localized_default: None | Unset | str = UNSET
    localized_forced: None | Unset | str = UNSET
    localized_external: None | Unset | str = UNSET
    display_title: None | Unset | str = UNSET
    nal_length_size: None | Unset | str = UNSET
    is_interlaced: Unset | bool = UNSET
    is_avc: None | Unset | bool = UNSET
    channel_layout: None | Unset | str = UNSET
    bit_rate: None | Unset | int = UNSET
    bit_depth: None | Unset | int = UNSET
    ref_frames: None | Unset | int = UNSET
    packet_length: None | Unset | int = UNSET
    channels: None | Unset | int = UNSET
    sample_rate: None | Unset | int = UNSET
    is_default: Unset | bool = UNSET
    is_forced: Unset | bool = UNSET
    height: None | Unset | int = UNSET
    width: None | Unset | int = UNSET
    average_frame_rate: None | Unset | float = UNSET
    real_frame_rate: None | Unset | float = UNSET
    profile: None | Unset | str = UNSET
    type: Unset | MediaStreamType = UNSET
    aspect_ratio: None | Unset | str = UNSET
    index: Unset | int = UNSET
    score: None | Unset | int = UNSET
    is_external: Unset | bool = UNSET
    delivery_method: None | SubtitleDeliveryMethod | Unset = UNSET
    delivery_url: None | Unset | str = UNSET
    is_external_url: None | Unset | bool = UNSET
    is_text_subtitle_stream: Unset | bool = UNSET
    supports_external_stream: Unset | bool = UNSET
    path: None | Unset | str = UNSET
    pixel_format: None | Unset | str = UNSET
    level: None | Unset | float = UNSET
    is_anamorphic: None | Unset | bool = UNSET

    def to_dict(self) -> dict[str, Any]:
        codec: None | Unset | str
        if isinstance(self.codec, Unset):
            codec = UNSET
        else:
            codec = self.codec

        codec_tag: None | Unset | str
        ...
        time_base: None | Unset | str
        if isinstance(self.time_base, Unset):
            time_base = UNSET
        else:
            time_base = self.time_base

        codec_time_base: None | Unset | str
        ...
        delivery_method: None | Unset | str
        if isinstance(self.delivery_method, Unset):
            delivery_method = UNSET
        elif isinstance(self.delivery_method, SubtitleDeliveryMethod):
            delivery_method = self.delivery_method.value
        else:
            delivery_method = self.delivery_method

        delivery_url: None | Unset | str
        if isinstance(self.delivery_url, Unset):
            delivery_url = UNSET
        else:
            delivery_url = self.delivery_url

        is_external_url: None | Unset | bool
        ...
        pixel_format: None | Unset | str
        if isinstance(self.pixel_format, Unset):
            pixel_format = UNSET
        else:
            pixel_format = self.pixel_format

        level: None | Unset | float
        if isinstance(self.level, Unset):
            level = UNSET
        else:
            level = self.level

        is_anamorphic: None | Unset | bool
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_codec(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_codec_tag(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_color_range(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_color_space(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_color_transfer(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_color_primaries(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dv_version_major(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dv_version_minor(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dv_profile(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dv_level(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_rpu_present_flag(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_el_present_flag(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_bl_present_flag(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_dv_bl_signal_compatibility_id(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_time_base(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_codec_time_base(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_video_range(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        video_range = _parse_video_range(d.pop("VideoRange", UNSET))

        def _parse_video_range_type(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        video_range_type = _parse_video_range_type(d.pop("VideoRangeType", UNSET))

        def _parse_video_do_vi_title(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_localized_undefined(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_localized_default(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_localized_forced(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_localized_external(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_display_title(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_nal_length_size(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_avc(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_channel_layout(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_bit_rate(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_bit_depth(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_ref_frames(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_packet_length(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_channels(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_sample_rate(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_average_frame_rate(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_real_frame_rate(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_profile(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_delivery_method(data: object) -> None | SubtitleDeliveryMethod | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                delivery_method_type_1 = SubtitleDeliveryMethod(data)

                return delivery_method_type_1
            except:  # noqa: E722
                pass
            return cast(None | SubtitleDeliveryMethod | Unset, data)

        delivery_method = _parse_delivery_method(d.pop("DeliveryMethod", UNSET))

        def _parse_delivery_url(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_external_url(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_pixel_format(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_level(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_anamorphic(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
