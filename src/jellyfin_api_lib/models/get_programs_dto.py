...
class GetProgramsDto:
    ...
    min_start_date: None | Unset | datetime.datetime = UNSET
    has_aired: None | Unset | bool = UNSET
    is_airing: None | Unset | bool = UNSET
    max_start_date: None | Unset | datetime.datetime = UNSET
    min_end_date: None | Unset | datetime.datetime = UNSET
    max_end_date: None | Unset | datetime.datetime = UNSET
    ...
    start_index: None | Unset | int = UNSET
    limit: None | Unset | int = UNSET
    ...
    enable_images: None | Unset | bool = UNSET
    enable_total_record_count: Unset | bool = UNSET
    image_type_limit: None | Unset | int = UNSET
    enable_image_types: Unset | list[ImageType] = UNSET
    enable_user_data: None | Unset | bool = UNSET
    series_timer_id: None | Unset | str = UNSET
    library_series_id: Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        start_index: None | Unset | int
        if isinstance(self.start_index, Unset):
            start_index = UNSET
        else:
            start_index = self.start_index

        limit: None | Unset | int
        ...
        sort_order: Unset | list[str] = UNSET
        ...
        enable_user_data: None | Unset | bool
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_min_start_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
        ...
        def _parse_has_aired(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_is_airing(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_max_start_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_min_end_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_max_end_date(data: object) -> None | Unset | datetime.datetime:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_start_index(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_limit(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_images(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_image_type_limit(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_enable_user_data(data: object) -> None | Unset | bool:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
