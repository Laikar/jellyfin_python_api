...
class PlaybackStartInfo:
    ...
    playback_start_time_ticks: None | Unset | int = UNSET
    volume_level: None | Unset | int = UNSET
    brightness: None | Unset | int = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        playback_start_time_ticks: None | Unset | int
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_playback_start_time_ticks(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        playback_start_time_ticks = _parse_playback_start_time_ticks(d.pop("PlaybackStartTimeTicks", UNSET))
        ...
        def _parse_brightness(data: object) -> None | Unset | int:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
