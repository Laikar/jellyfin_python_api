...
class SeriesTimerInfoDto:
    ...
    Attributes:
        ...
        day_pattern (Union[DayPattern, None, Unset]): Gets or sets the day pattern.
    ...
    external_channel_id: None | Unset | str = UNSET
    channel_name: None | Unset | str = UNSET
    channel_primary_image_tag: None | Unset | str = UNSET
    program_id: None | Unset | str = UNSET
    external_program_id: None | Unset | str = UNSET
    name: None | Unset | str = UNSET
    overview: None | Unset | str = UNSET
    start_date: Unset | datetime.datetime = UNSET
    end_date: Unset | datetime.datetime = UNSET
    service_name: None | Unset | str = UNSET
    priority: Unset | int = UNSET
    pre_padding_seconds: Unset | int = UNSET
    post_padding_seconds: Unset | int = UNSET
    is_pre_padding_required: Unset | bool = UNSET
    parent_backdrop_item_id: None | Unset | str = UNSET
    parent_backdrop_image_tags: list[str] | None | Unset = UNSET
    is_post_padding_required: Unset | bool = UNSET
    keep_until: Unset | KeepUntil = UNSET
    record_any_time: Unset | bool = UNSET
    skip_episodes_in_library: Unset | bool = UNSET
    record_any_channel: Unset | bool = UNSET
    keep_up_to: Unset | int = UNSET
    record_new_only: Unset | bool = UNSET
    days: list[DayOfWeek] | None | Unset = UNSET
    day_pattern: DayPattern | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        external_channel_id: None | Unset | str
        ...
        external_program_id: None | Unset | str
        ...
        day_pattern: None | Unset | str
        if isinstance(self.day_pattern, Unset):
            day_pattern = UNSET
        elif isinstance(self.day_pattern, DayPattern):
    ...
    def from_dict(cls: builtins.type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_external_channel_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_external_program_id(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_service_name(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_day_pattern(data: object) -> DayPattern | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                day_pattern_type_1 = DayPattern(data)

                return day_pattern_type_1
            except:  # noqa: E722
                pass
            return cast(DayPattern | None | Unset, data)

        day_pattern = _parse_day_pattern(d.pop("DayPattern", UNSET))
