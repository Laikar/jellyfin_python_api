...
class AccessSchedule:
    ...
    day_of_week: Unset | DynamicDayOfWeek = UNSET
    start_hour: Unset | float = UNSET
    end_hour: Unset | float = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        day_of_week: Unset | DynamicDayOfWeek
