...
class IPlugin:
    ...
    assembly_file_path: None | Unset | str = UNSET
    can_uninstall: Unset | bool = UNSET
    data_folder_path: None | Unset | str = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        assembly_file_path: None | Unset | str
        ...
        data_folder_path: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_assembly_file_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_data_folder_path(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
