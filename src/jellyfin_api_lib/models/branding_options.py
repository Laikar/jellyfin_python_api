...
class BrandingOptions:
    ...
    login_disclaimer: None | Unset | str = UNSET
    custom_css: None | Unset | str = UNSET
    splashscreen_enabled: Unset | bool = UNSET

    def to_dict(self) -> dict[str, Any]:
        login_disclaimer: None | Unset | str
        if isinstance(self.login_disclaimer, Unset):
            login_disclaimer = UNSET
        else:
            login_disclaimer = self.login_disclaimer

        custom_css: None | Unset | str
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        def _parse_login_disclaimer(data: object) -> None | Unset | str:
            if data is None:
                return data
        ...
        def _parse_custom_css(data: object) -> None | Unset | str:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
