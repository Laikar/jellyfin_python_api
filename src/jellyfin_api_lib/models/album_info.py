...
class AlbumInfo:
    ...
    album_artists: Unset | list[str] = UNSET
    artist_provider_ids: Union[Unset, "AlbumInfoArtistProviderIds"] = UNSET
    song_infos: Unset | list["SongInfo"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        artist_provider_ids: Unset | AlbumInfoArtistProviderIds
