...
def _get_kwargs(
    *,
    library_content_type: Unset | str = UNSET,
    is_new_library: Unset | bool = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | LibraryOptionsResultDto | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | LibraryOptionsResultDto]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        library_content_type (Union[Unset, str]):
