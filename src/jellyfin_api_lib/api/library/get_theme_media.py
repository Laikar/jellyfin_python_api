...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/Items/{item_id}/ThemeMedia",
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> AllThemeMediaResult | Any | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[AllThemeMediaResult | Any]:
    return Response(
