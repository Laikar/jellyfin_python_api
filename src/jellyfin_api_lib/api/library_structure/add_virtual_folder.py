...
def _get_kwargs(
    *,
    ...
    collection_type: Unset | CollectionTypeOptions = UNSET,
    paths: Unset | list[str] = UNSET,
    refresh_library: Unset | bool = False,
) -> dict[str, Any]:
    ...
    json_collection_type: Unset | str = UNSET
    ...
    json_paths: Unset | list[str] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        collection_type (Union[Unset, CollectionTypeOptions]):
