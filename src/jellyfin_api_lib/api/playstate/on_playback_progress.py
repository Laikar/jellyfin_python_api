...
def _get_kwargs(
    ...
    *,
    ...
    is_paused: Unset | bool = False,
    is_muted: Unset | bool = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_repeat_mode: Unset | str = UNSET
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/Users/{user_id}/PlayingItems/{item_id}/Progress",
        "params": params,
    }
