...
def _get_kwargs(
    *,
    ...
    is_liked: Unset | bool = UNSET,
    is_disliked: Unset | bool = UNSET,
    ...
    enable_favorite_sorting: Unset | bool = False,
    add_current_program: Unset | bool = True,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
