...
def _get_kwargs(
    *,
    ...
    min_start_date: Unset | datetime.datetime = UNSET,
    has_aired: Unset | bool = UNSET,
    is_airing: Unset | bool = UNSET,
    max_start_date: Unset | datetime.datetime = UNSET,
    min_end_date: Unset | datetime.datetime = UNSET,
    max_end_date: Unset | datetime.datetime = UNSET,
    ...
    series_timer_id: Unset | str = UNSET,
    ...
    json_min_start_date: Unset | str = UNSET
    ...
    json_max_start_date: Unset | str = UNSET
