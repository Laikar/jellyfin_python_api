...
def _get_kwargs(
    *,
    new_devices_only: Unset | bool = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | list["TunerHostInfo"] | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | list["TunerHostInfo"]]:
    return Response(
