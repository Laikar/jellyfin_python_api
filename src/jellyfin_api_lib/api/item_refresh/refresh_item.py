...
def _get_kwargs(
    item_id: str,
    *,
    metadata_refresh_mode: Unset | MetadataRefreshMode = MetadataRefreshMode.NONE,
    image_refresh_mode: Unset | MetadataRefreshMode = MetadataRefreshMode.NONE,
    replace_all_metadata: Unset | bool = False,
    replace_all_images: Unset | bool = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    json_metadata_refresh_mode: Unset | str = UNSET
    ...
    json_image_refresh_mode: Unset | str = UNSET
