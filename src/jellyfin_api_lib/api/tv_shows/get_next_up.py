...
def _get_kwargs(
    *,
    ...
    next_up_date_cutoff: Unset | datetime.datetime = UNSET,
    enable_total_record_count: Unset | bool = True,
    disable_first_episode: Unset | bool = False,
    enable_rewatching: Unset | bool = False,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_next_up_date_cutoff: Unset | str = UNSET
