...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/DisplayPreferences/{display_preferences_id}",
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | DisplayPreferencesDto | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | DisplayPreferencesDto]:
    return Response(
