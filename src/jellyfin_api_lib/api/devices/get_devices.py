...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Any | DeviceInfoQueryResult | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[Any | DeviceInfoQueryResult]:
    return Response(
...
def sync_detailed(
    *,
    ...
    supports_sync: Unset | bool = UNSET,
    user_id: Unset | str = UNSET,
) -> Response[Any | DeviceInfoQueryResult]:
    """Get Devices.
...
def sync(
    *,
    ...
    supports_sync: Unset | bool = UNSET,
    user_id: Unset | str = UNSET,
) -> Any | DeviceInfoQueryResult | None:
    """Get Devices.
