...
from ...models.head_master_hls_video_playlist_stream_options import HeadMasterHlsVideoPlaylistStreamOptions
...
def _get_kwargs(
    item_id: str,
    *,
    static: Unset | bool = UNSET,
    params: Unset | str = UNSET,
    tag: Unset | str = UNSET,
    device_profile_id: Unset | str = UNSET,
    play_session_id: Unset | str = UNSET,
    segment_container: Unset | str = UNSET,
    segment_length: Unset | int = UNSET,
    min_segments: Unset | int = UNSET,
    media_source_id: str,
    device_id: Unset | str = UNSET,
    audio_codec: Unset | str = UNSET,
    enable_auto_stream_copy: Unset | bool = UNSET,
    allow_video_stream_copy: Unset | bool = UNSET,
    allow_audio_stream_copy: Unset | bool = UNSET,
    break_on_non_key_frames: Unset | bool = UNSET,
    audio_sample_rate: Unset | int = UNSET,
    max_audio_bit_depth: Unset | int = UNSET,
    audio_bit_rate: Unset | int = UNSET,
    audio_channels: Unset | int = UNSET,
    max_audio_channels: Unset | int = UNSET,
    profile: Unset | str = UNSET,
    level: Unset | str = UNSET,
    framerate: Unset | float = UNSET,
    max_framerate: Unset | float = UNSET,
    copy_timestamps: Unset | bool = UNSET,
    ...
    video_bit_rate: Unset | int = UNSET,
    subtitle_stream_index: Unset | int = UNSET,
    subtitle_method: Unset | SubtitleDeliveryMethod = UNSET,
    max_ref_frames: Unset | int = UNSET,
    max_video_bit_depth: Unset | int = UNSET,
    require_avc: Unset | bool = UNSET,
    de_interlace: Unset | bool = UNSET,
    require_non_anamorphic: Unset | bool = UNSET,
    transcoding_max_audio_channels: Unset | int = UNSET,
    cpu_core_limit: Unset | int = UNSET,
    live_stream_id: Unset | str = UNSET,
    enable_mpegts_m2_ts_mode: Unset | bool = UNSET,
    video_codec: Unset | str = UNSET,
    subtitle_codec: Unset | str = UNSET,
    transcode_reasons: Unset | str = UNSET,
    audio_stream_index: Unset | int = UNSET,
    video_stream_index: Unset | int = UNSET,
    context: Unset | EncodingContext = UNSET,
    stream_options: Union[Unset, "HeadMasterHlsVideoPlaylistStreamOptions"] = UNSET,
    enable_adaptive_bitrate_streaming: Unset | bool = True,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    json_subtitle_method: Unset | str = UNSET
    ...
    _kwargs: dict[str, Any] = {
        "method": "head",
        "url": f"/Videos/{item_id}/master.m3u8",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        enable_adaptive_bitrate_streaming (Union[Unset, bool]):  Default: True.
