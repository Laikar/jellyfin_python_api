...
def _get_kwargs(
    *,
    ...
    supports_media_control: Unset | bool = False,
    supports_sync: Unset | bool = False,
    supports_persistent_identifier: Unset | bool = True,
) -> dict[str, Any]:
    params: dict[str, Any] = {}

    params["id"] = id

    json_playable_media_types: Unset | list[str] = UNSET
    ...
    json_supported_commands: Unset | list[str] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        supports_sync (Union[Unset, bool]):  Default: False.
